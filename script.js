  ...
  if(sub1>100 || sub2>100 || sub3>100 || sub4>100 || sub5>100 || sub6)
  {
    alert("Please Enter Marks in range of 100");
  }
  else {
    var total= sub1 + sub2 + sub3 + sub4 + sub5 +sub6;
    document.getElementById("total").innerHTML ="English Marks :"+sub1+"<br> Maths Marks: "+sub2+"<br> Physics Marks: "+sub3+"<br> Chemistry Marks: "+sub4+"<br> Computer Marks: "+sub5+" <br> Geography marks :"+sub6+"<br> Total Marks: "+total;  
  }
  }
